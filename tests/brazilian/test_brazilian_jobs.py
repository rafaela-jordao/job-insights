...
mock_dict = [
    ...
    {'salary': '1700', 'title': 'Assistente administrativo',
        'type': ' full time'},
    {'salary': '1400', 'title': 'Auxiliar administrativo',
        'type': ' full time'},
    ...
    {'salary': '4000', 'title': 'Analista de Departamento Pessoal',
        'type': ' full time'},
    {'salary': '50000', 'title': 'Esportista de Futebol profissional',
        'type': ' full time'},
    ...
    {'salary': ' 1400', 'title': 'Auxiliar de manutenção',
        'type': ' full time'}
    ]


def test_brazilian_jobs():
    assert read_brazilian_file("tests/mocks/brazilians_jobs.csv") == mock_dict
